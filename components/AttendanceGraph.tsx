              ...
              >
                ...
                <div className="flex-1 relative h-8 bg-white/5 rounded-lg overflow-hidden">
                  <motion.div
                    ...
                    className="absolute inset-y-0 left-0 bg-gradient-to-r from-[#ff9b6b] to-[#ff7a45] rounded-lg"
                  />
          ...
          return (
            <div className="mt-4 pt-4 border-t border-white/10">
              <p className="text-xs text-[#eaeaf0]/70">
                <span className="text-[#ff9b6b] font-medium">Peak time:</span> {formatTime(peakTime)} with {attendance[peakTime]} {attendance[peakTime] === 1 ? 'person' : 'people'}
              </p>
            </div>
          );
        }
