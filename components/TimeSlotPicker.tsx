  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="w-full rounded-xl bg-white/5 border border-white/10 px-4 py-3 text-left text-[#eaeaf0] hover:bg-white/10 transition-colors focus:outline-none focus:ring-2 focus:ring-[#ff9b6b]"
      >
          ...
          {timeSlots.map((slot) => (
            <button
              ...
              className={`w-full px-4 py-3 text-left transition-colors ${
                slot === selectedTime
                  ? 'bg-[#ff9b6b] text-[#0a0a0c] font-medium'
