    ...
    >
      ...
      {!codeSent ? (
        <button
          ...
          disabled={loading}
          className="w-full rounded-xl bg-[#ffc46a] px-6 py-3 font-medium text-[#0a0a0c] hover:opacity-90 disabled:opacity-50"
        >
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="000000"
              autoFocus
              className="w-full rounded-xl bg-white/10 px-6 py-4 text-center text-3xl font-mono tracking-widest text-[#eaeaf0] focus:outline-none focus:ring-2 focus:ring-[#ffc46a]"
            />
          </div>
