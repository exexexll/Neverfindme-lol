      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex-1 relative">
          <input
            ...
            placeholder="Message..."
            maxLength={500}
            className="w-full rounded-full bg-white/10 px-4 py-2.5 text-sm text-[#eaeaf0] placeholder-[#eaeaf0]/40 focus:outline-none focus:ring-2 focus:ring-[#ff9b6b] disabled:opacity-50 disabled:cursor-not-allowed"
          />
        ...
        <button
          ...
          className="flex-shrink-0 p-2.5 rounded-full bg-[#ff9b6b] hover:opacity-90 transition-opacity disabled:opacity-30 disabled:cursor-not-allowed"
