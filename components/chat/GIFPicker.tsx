      ...
      >
        ...
        <div className="p-4 border-b border-white/10">
          <input
            ...
            className="w-full rounded-full bg-white/10 px-4 py-2.5 text-sm text-[#eaeaf0] placeholder-[#eaeaf0]/40 focus:outline-none focus:ring-2 focus:ring-[#ffc46a]"
            autoFocus
          />
        </div>
      ...
      <div className="gif-scroll flex-1 overflow-y-scroll p-4" style={{
        ...
        {loading ? (
            <div className="flex items-center justify-center h-64">
              <div className="animate-spin rounded-full h-12 w-12 border-4 border-[#ffc46a] border-t-transparent" />
            </div>
          ) : gifs.length === 0 ? (
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
              {gifs.map(gif => (
                <button
                  ...
                  className="relative aspect-square rounded-lg overflow-hidden bg-white/5 hover:ring-2 hover:ring-[#ffc46a] transition-all group"
                >
