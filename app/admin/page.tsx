  ...
  useEffect(() => {
    ...
    fetch(`${API_BASE}/admin/verify`, {
      ...
      .catch((error) => {
        ...
        setTimeout(() => {
          localStorage.removeItem('bumpin_admin_token');
          router.push('/admin-login');
        }, 2000);
      });
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0c] p-4 sm:p-6 lg:p-8">
      ...
      {activeTab === 'event' && (
        <div className="space-y-6">
          {/* Event Mode Toggle */}
          <div className="rounded-xl bg-gradient-to-r from-[#ffc46a]/10 to-[#ff7a45]/10 border border-[#ffc46a]/30 p-6">
            <div className="flex items-start justify-between">
              <div>
                <h3 className="text-xl font-bold text-[#ffc46a] mb-2">
              ...
              <button
                ...
                className={`relative inline-flex h-8 w-14 items-center rounded-full transition-colors ${
                  eventModeEnabled ? 'bg-[#ffc46a]' : 'bg-white/20'
                }`}
              >
                <span
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <div>
                ...
                <input
                  ...
                  step="1800"
                  className="w-full rounded-lg bg-white/10 border border-white/20 px-4 py-2.5 text-[#eaeaf0] focus:outline-none focus:ring-2 focus:ring-[#ffc46a]"
                />
              </div>
          ...
          <div className="rounded-xl bg-white/5 border border-white/10 p-6">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                maxLength={50}
                className="w-full rounded-lg bg-white/10 border border-white/20 px-4 py-2.5 text-[#eaeaf0] placeholder-[#eaeaf0]/40 focus:outline-none focus:ring-2 focus:ring-[#ffc46a]"
              />
          ...
          {todayAttendance && todayAttendance.totalRSVPs > 0 && (
            <div className="rounded-xl bg-white/5 border border-white/10 p-6">
              ...
              <p className="text-3xl font-bold text-[#ffc46a] mb-2">
          ...
          <div className="flex justify-end">
            <button
              ...
              className="rounded-xl bg-[#ffc46a] px-8 py-3 font-medium text-[#0a0a0c] hover:opacity-90 transition-opacity disabled:opacity-50"
            >
