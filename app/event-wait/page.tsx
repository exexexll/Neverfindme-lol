      ...
      <div className="flex min-h-screen items-center justify-center bg-[#0a0a0c]">
        <div className="text-center">
          ...
          <button
            ...
            className="mt-4 rounded-xl bg-[#ffc46a] px-6 py-2 text-sm font-medium text-[#0a0a0c] hover:opacity-90"
          >
            Go to Dashboard
          </button>
        </div>
    ...
    <main className="min-h-screen bg-[#0a0a0c] py-8 px-4">
      <div className="container mx-auto max-w-3xl">
        ...
        <motion.div
          ...
          className="rounded-xl bg-gradient-to-r from-[#ffc46a]/20 to-[#ff7a45]/20 border border-[#ffc46a]/30 p-6 mb-6"
        >
          <div className="text-center">
            <p className="text-sm text-[#eaeaf0]/70 mb-2">Today&apos;s Event Window</p>
            <p className="font-playfair text-3xl font-bold text-[#ffc46a] mb-1">
            ...
            <div className="flex justify-center gap-4">
              <div className="text-center">
                <div className="rounded-lg bg-white/5 px-6 py-4 min-w-[80px]">
                  <p className="font-playfair text-4xl font-bold text-[#ffc46a]">
        ...
        >
          ...
          <button
            ...
            disabled={submitting}
            className="mt-4 w-full rounded-xl bg-[#ffc46a] px-6 py-3 font-medium text-[#0a0a0c] hover:opacity-90 transition-opacity disabled:opacity-50"
          >
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <button
              ...
              className="flex-1 rounded-xl bg-[#ffc46a] px-6 py-3 text-sm font-medium text-[#0a0a0c] hover:opacity-90 transition-all cursor-pointer active:scale-95 transform disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {navigatingToRefilm ? (
